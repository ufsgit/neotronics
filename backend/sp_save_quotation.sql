CREATE DEFINER=`root`@`localhost` PROCEDURE `Save_Quotation`(In SalesQuotationMaster_Id_ int,Account_Party_Id_ int, EntryDate_ varchar(45), 
...
Supplier_Ref_No_ VARCHAR(250),Quotation_Details_ JSON)
BEGIN

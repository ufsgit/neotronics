...
Supplier_Ref_No_ VARCHAR(250), Mobile_No_ VARCHAR(50), Email_ VARCHAR(100), Price_Request_Details_ JSON)
BEGIN
...
`;
        ...
        console.log("Successfully updated Save_Price_Request SP with Mobile_No and Email.");
        process.exit(0);
    } catch (err) {
        console.error(err);
        process.exit(1);

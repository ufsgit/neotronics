...
{ 
 ...
 Search_Sales_Order:function(Is_Date_Check_,FromDate_,ToDate_,Account_Party_Id_,Invoice_No_,Part_No_,Item_Group_Id_,CurrencyDetails_Id_,AccountType_Id_,User_Details_Id_,
    ...
    return db.query("CALL Search_Sales_Order(@Is_Date_Check_ :=?,@FromDate_ :=?,@ToDate_ :=?,@Account_Party_Id_ :=?,@Order_No_ :=?,@Part_No_ :=?,@Item_Group_Id_ :=?,@CurrencyDetails_Id_ :=?,@AccountType_Id_ :=?,@User_Details_Id_ :=?, "+
    ...
    Get_Sales_Order_Details:function(Sales_Order_Master_Id_,callback)
    { 
    return db.query("CALL Get_Sales_Order_Details(@Sales_Order_Master_Id_:=?)",[Sales_Order_Master_Id_],callback);
    } ,

    Delete_Sales_Order_Master:function(Sales_Order_Master_Id_,callback)
    { 
    return db.query("CALL Delete_Sales_Order_Master(@Sales_Order_Master_Id_ :=?)",[Sales_Order_Master_Id_],callback);
    },

    Get_Sales_Order_Master:function(Sales_Order_Master_Id_,callback)
    { 
    return db.query("CALL Get_Sales_Order_Master(@Sales_Order_Master_Id_ :=?)",[Sales_Order_Master_Id_],callback);
    } 

};
module.exports=Sales_Order_Master;
var Sales_Master=
{ 
...
Load_Cess:function(callback)
 ...
 Search_Customer_Typeahead:function(Account_Group_Id_,Client_Accounts_Name_,callback)
   ...
   return db.query("CALL Get_Deliveryordermaster_Purchaseordermaster_Checked_InvoiceNo(@DeliveryOrderMaster_Id_ :=?)",[DeliveryOrderMaster_Id_],callback);
    ...
    Load_Delivery_Order_Master:function(DeliveryOrderMaster_Id_,callback)
    {  return db.query("CALL Load_Delivery_Order_Master(@DeliveryOrderMaster_Id_ :=?)",[DeliveryOrderMaster_Id_],callback); },
    ...
    Load_SalesQuotationMaster:function(SalesQuotationMaster_Id_,callback)
    {  return db.query("CALL Load_SalesQuotationMaster(@SalesQuotationMaster_Id_ :=?)",[SalesQuotationMaster_Id_],callback); },
    ...
    Get_Proforma_Quotation_Details:function(SalesQuotationMaster_Id_,callback)
    {  return db.query("CALL Get_Proforma_Quotation_Details(@SalesQuotationMaster_Id_ :=?)",[SalesQuotationMaster_Id_],callback); },

    Load_PerformaInvoiceMaster:function(PerformaInvoiceMaster_Id_,callback)
    {  return db.query("CALL Load_PerformaInvoiceMaster(@PerformaInvoiceMaster_Id_ :=?)",[PerformaInvoiceMaster_Id_],callback); },

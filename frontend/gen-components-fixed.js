...
const components = [
  { category: 'Contacts', name: 'Designation', folder: 'Designation', filePrefix: 'designation', endpoint: 'designation', className: 'LeadDesignation' },
  { category: 'Requirement_Profile', name: 'ServiceProduct', folder: 'ServiceProduct', filePrefix: 'service-product', endpoint: 'service-product', className: 'LeadServiceProduct' },
  { category: 'Market_Study', name: 'MarketSystem', folder: 'MarketSystem', filePrefix: 'market-system', endpoint: 'market-system', className: 'LeadMarketSystem' },
  { category: 'Pipeline_Stage_Pulse', name: 'PipelineStage', folder: 'PipelineStage', filePrefix: 'pipeline-stage', endpoint: 'pipeline-stage', className: 'LeadPipelineStage' },
  { category: 'Pipeline_Stage_Pulse', name: 'Pulse', folder: 'Pulse', filePrefix: 'pulse', endpoint: 'pulse', className: 'LeadPulse' },
  { category: 'Pipeline_Stage_Pulse', name: 'TargetStage', folder: 'TargetStage', filePrefix: 'target-stage', endpoint: 'target-stage', className: 'LeadTargetStage' },
  { category: 'Assignment', name: 'Branch', folder: 'Branch', filePrefix: 'branch', endpoint: 'branch', className: 'LeadBranch' },
  { category: 'Assignment', name: 'Department', folder: 'Department', filePrefix: 'department', endpoint: 'department', className: 'LeadDepartment' },
  { category: 'Follow_up_Automation', name: 'Workflow', folder: 'Workflow', filePrefix: 'workflow', endpoint: 'workflow', className: 'LeadWorkflow' }
];
...
console.log('All components and services regenerated successfully.');

...
export class Stock_Add_Master_Service {
...
Save_Stock_Add_Master(Stock_Add_Master_)
{
    debugger
return this.http.post(environment.BasePath +'Stock_Add_Master/Save_Stock_Add_Master/',Stock_Add_Master_);}
...
Delete_Stock_Add_Master(Stock_Add_Master_Id)
{
 return this.http.get(environment.BasePath +'Stock_Add_Master/Delete_Stock_Add_Master/'+Stock_Add_Master_Id);}
Get_Stock_Add_Details(Stock_Add_Master_Id):Observable<any>
{
 return this.http.get(environment.BasePath +'Stock_Add_Details/Get_Stock_Add_Details/'+Stock_Add_Master_Id);
}

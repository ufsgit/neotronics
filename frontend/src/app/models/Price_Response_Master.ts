import { Price_Response_Details } from './Price_Response_Details';
export class Price_Response_Master {
    ...
    Description1: string;
    Price_Response_Details: Price_Response_Details[];

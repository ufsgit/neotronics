...
import { Requirement_Details } from '../../../models/Requirement_Details';
...
Requirement_Master_:Requirement_Master= new Requirement_Master();
Requirement_Details_Data:Requirement_Details[]
Requirement_Details_Data1:Requirement_Details[]
Requirement_Details_:Requirement_Details= new Requirement_Details();

Requirement_Details_Temp_ : Requirement_Details = new Requirement_Details();
Item_ :Requirement_Details = new Requirement_Details();
Item_Temp:Requirement_Details= new Requirement_Details();
Barcode_:Requirement_Details= new Requirement_Details();

Barcode_Temp_:Requirement_Details= new Requirement_Details();
...
Tot_Gross:number=0;
Requirement_Details_Index:number=-1;
...
Requirement_Details_Description:string;
...
Requirement_Master_Index:number=0;
...
Sales_Master_1:Requirement_Master= new Requirement_Master();
...
deliveryPendingData=[];purchasePendingView:boolean=false;purchasePendingData=[];printLetterhead:boolean = false;quotationListView:boolean = false; priceRequestListView:boolean = false; Quotation_Data = []; Price_Request_Data = [];
quotationPendingView: boolean = false; quotationPendingData: any[] = []; priceRequestPendingView: boolean = false; priceRequestPendingData: any[] = [];
/*** Added on 15-10-2024 */
...
/** Added on 16-10-2024 */
RequirementMaster_Id_Edit: number;
/*** Added on 17-10-2024 */
packingListPendingView: boolean = false;
/*** Added on 18-10-2024 */
...
ngOnInit() 
{
    ...
    this.RequirementMaster_Id = Number(localStorage.getItem('RequirementMaster_Id'));
...
Page_Load()
{
    ...
    this.Requirement_Master_.EntryDate=new Date("dd-MMM-yyyy").toString();
...
{  
    ...
    if(this.Requirement_Master_.Charge1per != 0)
        if(this.Requirement_Master_.Charge1per != null )
           if(this.Requirement_Master_.Charge1per != undefined )
           if(this.Requirement_Master_.Charge1per.toString() != '0')
            if(this.Requirement_Master_.Charge1per.toString() != 'null')
                    if(this.Requirement_Master_.Charge1per.toString() != 'undefined')
                        if(this.Requirement_Master_.Charge1per.toString() != '0.00')
                        {
                            this.printAcknowledgeCharge1per = true;
                        }
                        debugger;
   if(this.Requirement_Master_.charge1_Amount != 0)
       if(this.Requirement_Master_.charge1_Amount != null)
           if(this.Requirement_Master_.charge1_Amount != undefined )
      if( this.Requirement_Master_.charge1_Amount.toString() != '0')
   if( this.Requirement_Master_.charge1_Amount.toString() != 'null')
       if( this.Requirement_Master_.charge1_Amount.toString() != 'undefined' )
       if( this.Requirement_Master_.charge1_Amount.toString() != '0.000')
    {
        this.printAcknowledgeChargeAmount1 = true;
    }
debugger;
   if(this.Requirement_Master_.charge2_Amount != 0)
       if(this.Requirement_Master_.charge2_Amount != null)
           if(this.Requirement_Master_.charge2_Amount != undefined )
      if( this.Requirement_Master_.charge2_Amount.toString() != '0')
   if( this.Requirement_Master_.charge2_Amount.toString() != 'null')
       if( this.Requirement_Master_.charge2_Amount.toString() != 'undefined' )
       if( this.Requirement_Master_.charge2_Amount.toString() != '0.000')
    {
        this.printAcknowledgeChargeAmount2 = true;
    }
    debugger;
    if(this.Requirement_Master_.TotalDiscount != 0)
        if(this.Requirement_Master_.TotalDiscount != null )
           if(this.Requirement_Master_.TotalDiscount != undefined )
           if(this.Requirement_Master_.TotalDiscount.toString() != '0')
            if(this.Requirement_Master_.TotalDiscount.toString() != 'null')
                    if(this.Requirement_Master_.TotalDiscount.toString() != 'undefined')
                        if(this.Requirement_Master_.TotalDiscount.toString() != '0.000')
                        {
                            this.printAcknowledgeTotalDiscount = true;
                        }
                        debugger;
    if(this.Requirement_Master_.VAT_Amount != 0)
        if(this.Requirement_Master_.VAT_Amount != null )
           if(this.Requirement_Master_.VAT_Amount != undefined )
           if(this.Requirement_Master_.VAT_Amount.toString() != '0')
            if(this.Requirement_Master_.VAT_Amount.toString() != 'null')
                    if(this.Requirement_Master_.VAT_Amount.toString() != 'undefined')
                        {
                            this.printAcknowledgeVAT_Amount = true;
                        }
                        if(this.Requirement_Master_.Discount_Description != '0')
                            if(this.Requirement_Master_.Discount_Description != null )
                               if(this.Requirement_Master_.Discount_Description != undefined )
                               if(this.Requirement_Master_.Discount_Description.toString() != '0')
                                if(this.Requirement_Master_.Discount_Description.toString() != 'null')
                                        if(this.Requirement_Master_.Discount_Description.toString() != 'undefined')
                                            {
                                                this.printAcknowledgeDiscount_Description = true;
                                            }
                                            if(this.Requirement_Master_.Additional_Discount != 0)
                                                if(this.Requirement_Master_.Additional_Discount != null )
                                                   if(this.Requirement_Master_.Additional_Discount != undefined )
                                                   if(this.Requirement_Master_.Additional_Discount.toString() != '0')
                                                    if(this.Requirement_Master_.Additional_Discount.toString() != 'null')
                                                            if(this.Requirement_Master_.Additional_Discount.toString() != 'undefined')
                                                                if(this.Requirement_Master_.Additional_Discount.toString() != '0.00')
                                                                {
                                                                    this.printAcknowledgeAdditional_Discount = true;
                                                                }
                                                                if(this.Requirement_Master_.Roundoff_Amt != 0)
                                                                    if(this.Requirement_Master_.Roundoff_Amt != null )
                                                                       if(this.Requirement_Master_.Roundoff_Amt != undefined )
                                                                       if(this.Requirement_Master_.Roundoff_Amt.toString() != '0')
                                                                        if(this.Requirement_Master_.Roundoff_Amt.toString() != 'null')
                                                                                if(this.Requirement_Master_.Roundoff_Amt.toString() != 'undefined')
                                                                                    if(this.Requirement_Master_.Roundoff_Amt.toString() != '0.000')
                                                                                    {
  ...
  if(this.currency.CurrencyDetails_Id == 0)
    ...
    this.Requirement_Master_.PrintDate = this.formatPrintDate(this.Requirement_Master_.EntryDate);    
    //this.Customer_Name=this.Customer_.Client_Accounts_Name;
 
//     console.log("Requirement_Master_.charge1_Amount",this.Requirement_Master_.charge1_Amount)
//     console.log("Requirement_Master_.charge2_Amount",this.Requirement_Master_.charge2_Amount)
//     if(this.Requirement_Master_.charge1_Amount != 0 &&
//        this.Requirement_Master_.charge1_Amount != null &&
//        this.Requirement_Master_.charge1_Amount.toString() != 'null'&&
//        this.Requirement_Master_.charge1_Amount != undefined &&
//        this.Requirement_Master_.charge1_Amount.toString() != 'undefined'
//     )
//     {
...
// debugger;
//     if(this.Requirement_Master_.charge2_Amount != 0 &&
//         this.Requirement_Master_.charge2_Amount != null &&
//         this.Requirement_Master_.charge2_Amount.toString() != 'null'&&
//         this.Requirement_Master_.charge2_Amount != undefined &&
//         this.Requirement_Master_.charge2_Amount.toString() != 'undefined' &&
//         this.Requirement_Master_.charge2_Amount.toString() != '0.000'
//      )
//      {
...
//     console.log('this.printChargeAmount2: ', this.printChargeAmount2);
    ...
    //     if(this.Requirement_Master_.CurrencyId = this.currencyData[i].CurrencyDetails_Id){
    //     }        
    //    }
   //this.Load_Company() ;   
    ...
    setTimeout(() => {
        ...
        if (popupWinindow) {
            ...
            popupWinindow.document.write(`
                <html>
                    <head>
                        <title>Requirement Print</title>
                        <style>
                            ${this.Get_Requirement_Print_Css()}
                        </style>
                    </head>
...
Clr_Sales_Master()
{
    this.Requirement_Master_.RequirementMaster_Id=0;
    this.Requirement_Master_.Account_Party_Id=0;
    this.Requirement_Master_.User_Id=0;
    this.Requirement_Master_.Supplier_Ref_No="";
    this.Requirement_Master_.EntryDate=new Date().toString();
    this.Requirement_Master_.EntryDate=this.formatDate(this.Requirement_Master_.EntryDate);
    this.Requirement_Master_.RequirementNo="";
    this.Requirement_Master_.CurrencyId=0;
    this.Requirement_Master_.Brand="";
    this.Requirement_Master_.PriceBasis="";
    this.Requirement_Master_.PaymentTerms = null;
    this.Requirement_Master_.Payment_Term_Description = null;
    this.Requirement_Master_.Delivery = "";
    this.Requirement_Master_.Validity = "";
    this.Requirement_Master_.Description1 = "";
    this.Requirement_Master_.Discount_Description = null;
    this.Requirement_Master_.Charge1 = "";
    this.Requirement_Master_.Charge1per = null;
    this.Requirement_Master_.Charge2 = "";
    this.Requirement_Master_.PreparedBy = "";
    this.Requirement_Master_.VAT_Percentage = this.Default_Vat_Percentage;
    this.Requirement_Master_.Additional_Discount = null;
    this.Requirement_Master_.charge1_Amount = null;
    this.Requirement_Master_.charge2_Amount = null;
    this.Requirement_Master_.TotalDiscount = null;
    this.Requirement_Master_.VAT_Amount = null;
    this.Requirement_Master_.Total_Amount = null;
    this.Requirement_Master_.Roundoff_Amt = null;
    this.Requirement_Master_.Amount_In_Words = "";
    this.Requirement_Master_.NetTotal=null;
    this.Requirement_Master_.Cess=0;
    this.Requirement_Master_.RoundOff=0;
    this.Requirement_Master_.TotalAmount=0;
    this.Requirement_Master_.Description2="";
    this.Requirement_Master_.Address1="";
    this.Requirement_Master_.Address2="";
    this.Requirement_Master_.Address3="";
    this.Requirement_Master_.Address4="";
    this.Requirement_Master_.Mobile="";
    this.Requirement_Master_.Customer_Name="";
    this.Requirement_Master_.PinCode="";
    this.Requirement_Master_.GSTNo="";    
    this.Requirement_Master_.GrandTotal=0;
    this.Requirement_Master_.Transportation_Gst=null;
    this.Requirement_Master_.Handling_Gst=0;
    this.quotationListView = false;
    ...
    this.purchasePendingView = false;
    this.packingListPendingView = false;
    this.quotationPendingView = false;
    this.priceRequestPendingView = false;
    this.quotationPendingData = [];
    this.priceRequestPendingData = [];
    this.Requirement_Master_.Transportation_Total=null;
    this.Requirement_Master_.Handling_Total=null;
    this.Requirement_Master_.Vehicle_No="";
    this.Requirement_Master_.Driver_Name="";
    this.Requirement_Master_.PaymentTermValue = null;
    this.Requirement_Master_.Mobile_No = "";
    this.Requirement_Master_.Delivery_Address1 = "";
    this.Requirement_Master_.Delivery_Address2 = "";
    this.Requirement_Master_.Delivery_Address3 = "";
    this.Requirement_Master_.Delivery_Address4 = "";
    ...
    this.Address4 = null;
    this.Vatin = null;
    this.Requirement_Master_.POnumber = null;
    this.Attention = null;
    this.Employee = null;
    this.Requirement_Master_.TotalAmount = 0;
    this.Total = 0;
    ...
    this.Requirement_Master_.KindAttend = '';
    this.Requirement_Master_.AttendEmployee = '0';
...
Clr_Sales_Details()
{
    this.Requirement_Details_Index=-1;
    this.Requirement_Details_.RequirementDetails_Id=0;
    this.Requirement_Details_.RequirementMaster_Id=0;
    this.Requirement_Details_.StockId=0;
    //this.Requirement_Details_.Stock_Details_Id=0;
    this.Requirement_Details_.ItemId=0;
    this.Requirement_Details_.ItemName="";
    this.Requirement_Details_.Item_Code="";
    this.Requirement_Details_.GroupId=0;
    this.Requirement_Details_.GroupName="";
    this.Requirement_Details_.UnitId=0;
    this.Requirement_Details_.UnitName="";
    this.Requirement_Details_.PurchaseRate=0;
    this.Requirement_Details_.UnitPrice=0;
    this.Requirement_Details_.MRP=0;
    this.Requirement_Details_.TaxAmount=0;
    this.Requirement_Details_.Stock=0;
    this.Requirement_Details_.HSNCODE="";
    this.Requirement_Details_.SaleTax=0;
    this.Requirement_Details_.part_number='';

    this.Requirement_Details_.Quantity=0;
    this.Requirement_Details_.Discount=0;
    this.Requirement_Details_.NetValue=0;
    this.Requirement_Details_.Description="";    
    this.UnitName = "";
    this.Quantity = 0;
    this.SaleRate = 0;
    this.discount = 0;
    this.Requirement_Details_.Unit_Discount = 0;
    this.TotalAmount = 0;
    this.Requirement_Details_.Availability = '';
    this.Barcode_=null;
    // Keep ItemCodeData loaded for dropdown
    this.Item_ =null;
    this.Barcode_ =null;
    // this.Item_.ItemName="";
...
Delete_Sales_Details(Requirement_Details_e:Requirement_Details,index)
{
    ...
    this.Edit_SGST=Requirement_Details_e.SGSTAMT;
    this.Edit_GST=Requirement_Details_e.TaxAmount;
    this.Edit_Discount=Number(Requirement_Details_e.Discount);
    this.Edit_Cess=Requirement_Details_e.CessAMT;
    this.Edit_Net=Requirement_Details_e.NetValue;
    this.Edit_Gross=Requirement_Details_e.GrossValue;
    this.Edit_Totamt=Requirement_Details_e.TotalAmount;
    ...
    this.Requirement_Master_.GrossTotal=this.Requirement_Master_.GrossTotal-this.Edit_Gross;
    this.Requirement_Master_.TotalDiscount=this.Requirement_Master_.TotalDiscount-this.Edit_Discount;
    this.Requirement_Master_.NetTotal= this.Requirement_Master_.NetTotal-this.Edit_Net;
    this.Requirement_Master_.TotalCGST= this.Requirement_Master_.TotalCGST-this.Edit_CGST;
    this.Requirement_Master_.ToalSGST=   this.Requirement_Master_.ToalSGST-this.Edit_SGST;
    this.Requirement_Master_.Cess=  this.Requirement_Master_.Cess-this.Edit_Cess;
    this.Requirement_Master_.TotalAmount= this.Requirement_Master_.TotalAmount- this.Edit_Totamt;
    this.Requirement_Master_.TotalGST=   this.Requirement_Master_.TotalGST-this.Edit_GST;
    //this.Requirement_Master_.GrandTotal= this.Requirement_Master_.GrandTotal-this.Edit_Totamt;
    this.Requirement_Master_.GrossTotal=Number(this.Requirement_Master_.GrossTotal.toFixed(2));
    this.Requirement_Master_.TotalDiscount=Number(this.Requirement_Master_.TotalDiscount.toFixed(2));
    this.Requirement_Master_.NetTotal=Number(this.Requirement_Master_.NetTotal.toFixed(2));
    this.Requirement_Master_.TotalCGST=Number(this.Requirement_Master_.TotalCGST.toFixed(2));
    this.Requirement_Master_.ToalSGST=Number(this.Requirement_Master_.ToalSGST.toFixed(2));
    this.Requirement_Master_.Cess=Number(this.Requirement_Master_.Cess.toFixed(2));
    this.Requirement_Master_.TotalAmount=Number(this.Requirement_Master_.TotalAmount.toFixed(2));
    this.Requirement_Master_.TotalGST=Number(this.Requirement_Master_.TotalGST.toFixed(2));   
    this.Requirement_Master_.GrandTotal=Number(this.Requirement_Master_.GrandTotal.toFixed(2));*/   
    this.Requirement_Details_Data.splice(index, 1);   
    this.Final_Amounts();
...
Delete_Requirement_Master(RequirementMaster_Id,index)
 {
    const dialogRef = this.dialogBox.open
    ...
    this.Requirement_Master_Service_.Delete_Requirement_Master(RequirementMaster_Id).subscribe((Delete_status: any) => {    
        ...
        var Status_Row = null;
        if (Delete_status && Delete_status.length > 0 && Delete_status[0] && Delete_status[0].length > 0) {
            Status_Row = Delete_status[0][0];
        }
        ...
        {
            // Fallback for undefined/empty response, assuming success or just showing dialog to avoid UI freeze
            this.Requirement_Master_Data.splice(index, 1);
            const dialogRef = this.dialogBox.open( DialogBox_Component, {panelClass:'Dialogbox-Class',data:{Message:'Deleted',Type:"false"}});
            this.Search_Requirement();
        }
...
Load_Bill_Mode()
{
        this.Requirement_Master_Service_.Load_Bill_Mode().subscribe(Rows => {    
...
Load_Cess()
{
    this.Requirement_Master_Service_.Load_Cess().subscribe(Rows => {        
        if (Rows != null) {
         //   Rows=0;//Rows[0];
...
{
    debugger;
    this.Requirement_Master_Service_.Load_Company_Bank().subscribe(Rows => {   
      if (Rows != null && Rows[0] != null) {
            debugger;
...
Customer_Change( Customer_T_)
{
    ...
    this.Requirement_Master_.Customer_Name=this.Customer_.Client_Accounts_Name;
    this.Requirement_Master_.Customer=this.Customer_.Client_Accounts_Name;
    this.Requirement_Master_.Account_Party_Id=this.Customer_.Client_Accounts_Id;

    this.Requirement_Master_.Address1 = this.Customer_.Address1;
    this.Requirement_Master_.Address2 = this.Customer_.Address2;
    this.Requirement_Master_.Address3 = this.Customer_.Address3;
    this.Requirement_Master_.Address4 = this.Customer_.Address4;
    this.Requirement_Master_.Mobile = this.Customer_.Mobile;
    this.Requirement_Master_.PinCode=this.Customer_.PinCode;
    this.Requirement_Master_.GSTNo=this.Customer_.GSTNo;
    this.Customer_Name = this.Requirement_Master_.Customer_Name;

    this.Address1 = this.Requirement_Master_.Address1;
    this.Address2 = this.Requirement_Master_.Address2;
    this.Address3 = this.Requirement_Master_.Address3;
    this.Address4 = this.Requirement_Master_.Address4;
    this.Vatin = this.Requirement_Master_.GSTNo;
}
selectCustomer(){
    //this.customer_name=this.Customer_.Client_Accounts_Name;
    this.Requirement_Master_.Customer_Name=this.Customer_.Client_Accounts_Name;
...
Item_Name_Change(Item_sl:Requirement_Details){ 
    debugger
    const item: any = Item_sl as any;

    this.Requirement_Details_Temp_.ItemId = item.Item_Id || item.ItemId || 0;
    this.Requirement_Details_Temp_.ItemName = item.Item_Name || item.ItemName || '';
    this.Item_ = Object.assign({}, this.Requirement_Details_Temp_);

    this.Requirement_Details_.Item_Code = item.Item_Code || item.ItemCode || '';
    this.Requirement_Details_.part_number = this.Requirement_Details_.Item_Code;
...
Set_Workflow_Tab(tab: 'Requirement' | 'PriceRequestPending' | 'QuotationPending') {
    this.Entry_View = false;
    this.Workflow_Tab = tab;
    if (tab === 'PriceRequestPending') this.Load_Price_Request_Pending();
    if (tab === 'QuotationPending') this.Load_Quotation_Pending();
}
...
Quotation_Pending_Click(master: any) {
    const id = Number(master.RequirementMaster_Id || master.RequirementMaster_Id_ || master.Requirement_Master_Id || 0);
    if (!id) return;
    this.quotationPendingView = true;
    this.priceRequestPendingView = false;
    this.quotationListView = false;
    this.priceRequestListView = false;
    this.proformaListView = false;
...
PriceRequest_Pending_Click(master: any) {
    const id = Number(master.RequirementMaster_Id || master.RequirementMaster_Id_ || master.Requirement_Master_Id || 0);
    if (!id) return;
    this.priceRequestPendingView = true;
    this.quotationPendingView = false;
    this.quotationListView = false;
    this.priceRequestListView = false;
    this.proformaListView = false;
...
closeQuotationListView() {
    this.quotationListView = false;
}

closePriceRequestListView() {
    this.priceRequestListView = false;
}

View_Edit_Quotation_Click(master: any) {
    const qid = Number(master.quotation_master_id || master.SalesQuotationMaster_Id || master.SalesQuotationMaster_Id_ || 0);
    if (!qid) return;
    localStorage.setItem('SalesQuotationMaster_Id', String(qid));
    this.router.navigateByUrl('/Quotation');
}
...
{    
      debugger
    // Barcode_sl is now an Item Master row (from Item/Search_Item)
    const item: any = Barcode_sl as any;
    this.Barcode_ = item;
    ...
    this.Requirement_Details_.ItemName = item.Item_Name || item.ItemName || '';
    this.Requirement_Details_.ItemId = item.Item_Id || item.ItemId || 0;
    this.Requirement_Details_.StockId = this.Requirement_Details_.StockId || 0;

    // Bind item name autocomplete model (internal)
    this.Requirement_Details_Temp_.ItemId = this.Requirement_Details_.ItemId;
    this.Requirement_Details_Temp_.ItemName = this.Requirement_Details_.ItemName;
    this.Item_ = Object.assign({}, this.Requirement_Details_Temp_);

    //if(this.Requirement_Details_.Quantity==null || this.Requirement_Details_.Quantity==undefined || this.Requirement_Details_.Quantity==0)
    this.Requirement_Details_.Quantity=0;
    // if (this.Requirement_Details_.UnitPrice==null || this.Requirement_Details_.UnitPrice==undefined || this.Requirement_Details_.UnitPrice==0)
    //     this.Requirement_Details_.UnitPrice=0;
}

Fill_Tax_From_Item_Master(itemCode: string) {
    if (!itemCode) return;
    this.Item_Service_.Search_Item('', 0, itemCode).subscribe(Rows => {
        if (Rows && Rows[0] && Rows[0].length > 0) {
            const item: any = Rows[0][0];
        }
    }, _err => {});
}
Calculate_Requirement_Details_Amount()
{
    debugger
    if(this.Requirement_Details_.Quantity == undefined || this.Requirement_Details_.Quantity == null)
    this.Requirement_Details_.Quantity = 0;
    if(this.Requirement_Details_.UnitPrice == undefined || this.Requirement_Details_.UnitPrice == null)
    this.Requirement_Details_.UnitPrice = 0;
...
{ 
    debugger;
    if(this.Requirement_Details_.Discount == undefined || this.Requirement_Details_.Discount == null)
        this.Requirement_Details_.Discount = 0;
    ...
    this.Requirement_Details_.Amount=Number(this.Requirement_Details_.Amount.toFixed(3));    
    this.Requirement_Details_.TaxableAmount=Number(this.Requirement_Details_.TaxableAmount.toFixed(3));
    this.Requirement_Details_.TaxAmount=Number(this.Requirement_Details_.TaxAmount.toFixed(3));  
    this.Requirement_Details_.NetValue= Number(this.Requirement_Details_.NetValue.toFixed(3));    
}
Round_Off_Calculation()
{   
    if(this.Requirement_Master_.RoundOff == undefined || this.Requirement_Master_.RoundOff == null)
        {
            this.Requirement_Master_.RoundOff = 0;
            this.Requirement_Master_.RoundOff = Number(this.Requirement_Master_.RoundOff.toFixed(3));
        }  
    this.Requirement_Master_.GrandTotal = Number(this.Requirement_Master_.RoundOff) + Number(this.Requirement_Master_.TotalAmount);    
    this.Requirement_Master_.GrandTotal = Number(this.Requirement_Master_.GrandTotal.toFixed(3));
}
checkbox_Click()
{ 
    this.Final_Amounts();
...
Manual_Roundoff_Calculation()
{
    ...
    this.roundoff_value=this.Requirement_Master_.TotalAmount-(Math.round(this.Requirement_Master_.TotalAmount));
    if(this.roundoff_value<Number(Point_))
    this.roundoff_value=- this.roundoff_value;
   // this.Requirement_Master_.TotalAmount=this.Requirement_Master_.TotalAmount+  this.roundoff_value;
    this.Requirement_Master_.RoundOff=Number(this.roundoff_value);
    this.Requirement_Master_.RoundOff=Number(this.Requirement_Master_.RoundOff.toFixed(3));
    this.Requirement_Master_.TotalAmount= Number(this.Requirement_Master_.TotalAmount.toFixed(3));
}
Calculation_GSt()
{
    if(this.Requirement_Master_.Isgst==true)
    {
        this.Requirement_Master_.Transportation_Gst = Number(this.Requirement_Master_.Transportation_Charge) * (18 / 100)
        this.Requirement_Master_.Transportation_Total = Number(this.Requirement_Master_.Transportation_Charge) + Number(this.Requirement_Master_.Transportation_Gst) ;
        this.Requirement_Master_.Handling_Gst = (this.Requirement_Master_.Handling_Charge) * (18 / 100)
        this.Requirement_Master_.Handling_Total = Number(this.Requirement_Master_.Handling_Charge) + Number(this.Requirement_Master_.Handling_Gst);
   }
}
Search_Requirement()
{
    ...
    debugger
    this.Requirement_Master_Service_.Search_Requirement(look_In_Date_Value,moment(this.Search_FromDate).format('YYYY-MM-DD'), 
...
{ 
    if (this.Requirement_Details_Index >= 0) {
        this.Requirement_Details_Data[this.Requirement_Details_Index] = Object.assign({}, this.Requirement_Details_);
        }
    else {
        //this.Requirement_Details_.Barcode=this.Barcode_.Barcode;
        this.Requirement_Details_Data.push(Object.assign({}, this.Requirement_Details_));
}
this.Final_Amounts();
this.Requirement_Details_Index=-1;
this.Clr_Sales_Details();
 }
Plus_Requirement_Details()
{
if(this.Requirement_Details_.StockId>0)
    this.Requirement_Details_.StockId=this.Requirement_Details_.StockId;
else
    this.Requirement_Details_.StockId=0;
...
else if(this.Barcode_!=undefined && this.Barcode_!=null)
{
    ...
    this.Requirement_Details_.Item_Code=Barcode_string;
}
if( this.Item_==null)
    {
        this.Requirement_Details_.ItemName='';
    ...
    else if(this.Item_!=undefined && this.Item_!=null)
    {
        ...
        this.Requirement_Details_.ItemName=Itemnamestoing;
    }

    // Ensure tax fields are mapped before saving details
    this.Requirement_Details_.part_number = this.Requirement_Details_.Item_Code;
    this.Requirement_Details_.Expiry_Date=this.New_Date(new Date(moment(this.Requirement_Details_.Expiry_Date).format('YYYY-MM-DD')));
    this.Requirement_Details_.UnitPrice = parseFloat(Number(this.Requirement_Details_.UnitPrice).toFixed(3));
    //this.Requirement_Details_.Quantity = parseFloat(Number(this.Requirement_Details_.Quantity).toFixed(3));         
    if (this.Requirement_Details_Index >= 0) 
    {
        this.Requirement_Details_Data[this.Requirement_Details_Index] = Object.assign({}, this.Requirement_Details_);
    }
    ...
    debugger
   // console.log('this.Requirement_Details_Data: ', this.Requirement_Details_Data);
    this.addBlankRows();
    this.Requirement_Details_Index=-1;
    this.Clr_Sales_Details();  
    this.Final_Amounts();
...
Save_Requirement(Printstatus:number)
{
    debugger;
    if(this.Requirement_Details_Data == undefined || this.Requirement_Details_Data == null || this.Requirement_Details_Data.length == 0 || this.Requirement_Details_Data.length == undefined )
    {
    ...
    debugger
    if(this.Requirement_Master_.RequirementNo == '' || this.Requirement_Master_.RequirementNo == null || this.Requirement_Master_.RequirementNo == undefined)
    {
        this.Requirement_Master_.RequirementNo = "0";
    }
    debugger;
    this.Requirement_Master_.EntryDate = this.New_Date(new Date(moment(this.Requirement_Master_.EntryDate).format('YYYY-MM-DD')));
...
Edit_Button_Click()
{
    if (this.User_Type_Id == 1 || this.Requirement_Master_Data[this.Requirement_Master_Index].User_Id.toString() == this.Login_User_Id)
    {
...
{
  //  if (this.Requirement_Master_Index == -1)
    {
...
Edit_Requirement_Master(Sales_Master_e,index)
{ 
    debugger;
    this.Entry_View=true;
    this.Edit_Sales=1;
    ...
    this.Customer_Temp.Client_Accounts_Name=Sales_Master_e.Customer_Name;
    this.Customer_=this.Customer_Temp;
    console.log(this.Customer_Data)
debugger;
    this.Customer_Name=Sales_Master_e.Customer_Name;
    this.Requirement_Master_.Customer_Name=this.Customer_.Client_Accounts_Name;
    this.Requirement_Master_.Customer=this.Requirement_Master_.Customer_Name; 
    ...
    //                 this.Customer_= this.Customer_Temp;
    //                this.Requirement_Master_.Customer=result[0][0].Client_Accounts_Name;
    //                this.Requirement_Master_.Customer_Name=result[0][0].Client_Accounts_Name;
    ...
    // })
     debugger
    this.Requirement_Master_Service_.Search_Customer_Typeahead_1('1,2,3,39',"").subscribe(Rows => { 
        debugger    
        if (Rows != null && Rows[0] != null) {
            debugger
            this.Customer_Data = Rows[0];
            for(let i=0;i<Rows[0].length;i++){
                if(Rows[0][i].Client_Accounts_Id == this.Requirement_Master_.Account_Party_Id){

                    // Create a new object to trigger Angular change detection for mat-autocomplete displayWith
                    var matchedCustomer = new Client_Accounts();
                    matchedCustomer.Client_Accounts_Id=Rows[0][i].Client_Accounts_Id;
                    matchedCustomer.Client_Accounts_Name=Rows[0][i].Client_Accounts_Name;
                    this.Customer_= matchedCustomer;

                    this.Requirement_Master_.Account_Party_Id=Rows[0][i].Client_Accounts_Id;
                    this.Requirement_Master_.Customer=Rows[0][i].Client_Accounts_Name;
                    this.Requirement_Master_.Customer_Name=Rows[0][i].Client_Accounts_Name;
                    this.Requirement_Master_.Address1 = Rows[0][i].Address1;
                    this.Requirement_Master_.Address2 = Rows[0][i].Address2;
                    this.Requirement_Master_.Address3 = Rows[0][i].Address3;
                    this.Requirement_Master_.Address4 = Rows[0][i].Address4;
                    this.Requirement_Master_.Vatin = Rows[0][i].GSTNo;
    ...
    if(this.Requirement_Master_.Additional_Discount) this.addDiscCheck = 1;
    else this.addDiscCheck = 0;
    if(this.currencyData != undefined && this.currencyData != null)
    {
        for(let i=0;i<this.currencyData.length;i++)
        {
            if(this.currencyData[i].CurrencyDetails_Id == this.Requirement_Master_.CurrencyId)
            {
    ...
    if(this.PaymentTermData != undefined && this.PaymentTermData != null)
    {
        ...
        {
            if(this.PaymentTermData[i].payment_Term_ID == this.Requirement_Master_.Payment_Term_Description)
            {
        ...
        if (Rows != null) {
            ...
            if(this.Requirement_Details_Data){
                this.Requirement_Details_Data.forEach((element:any) => {
                    ...
                    {
                        element.Item_Code = element.ItemCode;
                    }
                });
            }
            this.Calculate_Requirement_Details_Amount();
            this.Final_Amounts();
            this.addBlankRows();        
        }
        this.isLoading = false;
...
Edit_Sales_Details(Requirement_Details_e:Requirement_Details,index)
{   
    this.Requirement_Details_Index=index;
    this.Requirement_Details_=Requirement_Details_e;
    this.Stock_Temp.ItemId=Requirement_Details_e.ItemId;
    this.Stock_Temp.ItemName=Requirement_Details_e.ItemName;
    this.Stock_=Object.assign({},this.Stock_Temp);
    this.Barcode_Temp.Stock_Id=Requirement_Details_e.StockId;
    //this.Barcode_Temp.Barcode=Requirement_Details_e.Barcode;
    // this.Barcode_=Object.assign({},this.Barcode_Temp);    
    this.Edit_GST=this.Requirement_Details_.TaxAmount;
    this.Edit_Discount=this.Requirement_Details_.Discount;
    this.Edit_Net=this.Requirement_Details_.NetValue;
    this.Requirement_Details_=Object.assign({},Requirement_Details_e);
    this.Sale_Detail_Quantity=this.Requirement_Details_.Quantity;
    this.Edit_Stock_-this.Requirement_Details_.Stock;
    this.Requirement_Details_Description=this.Requirement_Details_.Description;
}
...
Get_Stock(){
    ...
    this.Stock_=Object.assign({},this.Stock_Temp);
    this.Requirement_Details_.ItemId=this.Barcode_.ItemId;
    this.Requirement_Details_.ItemName=this.Barcode_.ItemName;
    this.Requirement_Details_.UnitId=this.Barcode_.UnitId;
    this.Requirement_Details_.UnitName=this.Barcode_.UnitName;
    this.Requirement_Details_.MRP=this.Barcode_.MRP;
    this.Requirement_Details_.PurchaseRate=this.Barcode_.PurchaseRate;
    this.Requirement_Details_.Stock=this.Barcode_.Quantity;
    this.Requirement_Details_.UnitPrice=this.Barcode_.SaleRate;
    this.Requirement_Details_.ItemName=this.Barcode_.ItemName;
    this.Requirement_Details_.GroupId=this.Barcode_.GroupId;
    this.Requirement_Details_.GroupName=this.Barcode_.GroupName;
    this.Requirement_Details_.HSNMasterId=this.Barcode_.HSNMasterId;
    this.Requirement_Details_.HSNCODE=this.Barcode_.HSNCODE;
    this.Requirement_Details_.HSNMasterId=this.Barcode_.HSNMasterId;
    this.Requirement_Details_.Item_Code=this.Barcode_.Item_Code;  
}
Get_Stock_Item() {
...
formatDate(dateString): string {
  ...
  Delete_Requirement_Detail(itemIndex){
    this.Requirement_Details_Data.splice(itemIndex, 1);
    console.log('Requirement_Details_Data: ', this.Requirement_Details_Data);
    this.addBlankRows();
    this.Final_Amounts();
  } 
  
  Edit_Requirement_Detail(Sales_Details_e:Requirement_Details, index){
    this.Requirement_Details_Index=index;
debugger;
    ...
    this.Requirement_Details_=Object.assign({},Sales_Details_e);
  }
  duplicate(){
  ...
  Proforma_Pending_Click(){
    ...
    this.purchasePendingView = false;
    this.packingListPendingView = false;
    this.Requirement_Master_Service_.Load_Profoma_Items_Pending_List_ByRequirement(this.Requirement_Master_.RequirementMaster_Id).subscribe(Rows => {
  ...
  Invoice_Pending_Click(){
    ...
    this.purchasePendingView = false;
    this.packingListPendingView = false;
    this.Requirement_Master_Service_.Load_Invoice_Items_Pending_List_ByRequirement(this.Requirement_Master_.RequirementMaster_Id).subscribe(Rows => {
  ...
  Delivery_Pending_Click(){
    ...
    this.purchasePendingView = false;
    this.packingListPendingView = false;
    this.Requirement_Master_Service_.Load_Delivery_Items_Pending_List_ByRequirement(this.Requirement_Master_.RequirementMaster_Id).subscribe(Rows => {
  ...
  Purchase_Pending_Click(){
    ...
    this.doListView = false;
    this.packingListPendingView = false;
    this.Requirement_Master_Service_.Load_Purchase_Items_Pending_List_ByRequirement(this.Requirement_Master_.RequirementMaster_Id).subscribe(Rows => {
       debugger;
           ...
           if(this.Requirement_Master_.VAT_Amount.toString() != '0')
            if(this.Requirement_Master_.VAT_Amount.toString() != 'null')
                    if(this.Requirement_Master_.VAT_Amount.toString() != 'undefined')
                        ...
                        if(this.Requirement_Master_.Discount_Description != '')
                            if(this.Requirement_Master_.Discount_Description != null )
                               if(this.Requirement_Master_.Discount_Description != undefined )
                               if(this.Requirement_Master_.Discount_Description.toString() != '0')
                                if(this.Requirement_Master_.Discount_Description.toString() != 'null')
...
//     debugger
//     this.Requirement_Master_Service_.Load_Delivery_Order_Master(this.DeliveryOrderMaster_Id).subscribe(result=>{
//         this.Requirement_Master_=new Requirement_Master()
//         this.Requirement_Master_=Object.assign({},result[0][0]); 
//         this.Requirement_Master_.PaymentTermValue=result[0][0].Payment_Term_Value
//         this.Requirement_Master_.POnumber = result[0][0].POnumber;
//         this.Entry_View = true;
// debugger
//         this.Requirement_Master_Service_.Search_Customer_Typeahead('1,2,3,39,36','').subscribe(Rows => {     
//             if (Rows != null) {
//                 debugger;
//                 this.Customer_Data = Rows[0];
...
//             }
//             });        
//         this.Requirement_Master_Service_.Get_Performa_invoice_Details(result[0][0].PerformaInvoiceMaster_Id).subscribe(Rows => { 
//             if (Rows != null) {
...
debugger;
        this.Requirement_Master_Service_.Load_RequirementMaster(this.RequirementMaster_Id).subscribe(result=>{
            this.Requirement_Master_=new Requirement_Master();
            this.Requirement_Master_Data=result[0];
            this.Requirement_Master_=Object.assign({},result[0][0]); 
            this.Requirement_Master_.PaymentTermValue=result[0][0].PaymentTermValue
            this.Requirement_Master_.POnumber = result[0][0].POnumber;          
        this.Edit_Sales=1;
        this.Sales_Print = false;    
        ...
        this.RequirementMaster_Id_Edit = this.RequirementMaster_Id;

        // this.Client_Accounts_Service_.Get_Client_Accounts(this.Requirement_Master_.Account_Party_Id).subscribe((result)=>{
        //     if(result!=null)
        //     {
        //         debugger
        //                 this.Customer_Temp.Client_Accounts_Id=result[0][0].Client_Accounts_Id;
        ...
        //                 this.Requirement_Master_.Address1 = result[0][0].Address1;
        //                 this.Requirement_Master_.Address2 = result[0][0].Address2;
        //                 this.Requirement_Master_.Address3 = result[0][0].Address3;
        //                 this.Requirement_Master_.Address4 = result[0][0].Address4;
        //                 this.Requirement_Master_.Vatin = result[0][0].GSTNo;
        ...
        //     }
        // });
    this.Requirement_Master_Service_.Search_Customer_Typeahead_1('1,2,3,36,37,38,39',"").subscribe(Rows => {  
        if (Rows != null) {
            this.Customer_Data = Rows[0];
            for(let i=0;i<this.Customer_Data.length;i++){
                if(this.Customer_Data[i].Client_Accounts_Id == this.Requirement_Master_.Account_Party_Id){
    ...
    console.log("QUO - Outside Get_Requirement_Details ");
    this.Requirement_Master_Service_.Get_Requirement_Details(result[0][0].RequirementMaster_Id).subscribe(Rows => { 
        debugger;
        ...
        console.log('QUO - Rows 1: ', Rows);
            ...
            console.log('QUO - Requirement_Details_Data: ', this.Requirement_Details_Data);
            this.Calculate_Requirement_Details_Amount();
            this.Final_Amounts();
            this.addBlankRows();        
            }
      ...
      makeInvoice(){
        localStorage.setItem('RequirementNo', this.Requirement_Master_.RequirementMaster_Id.toString());
        this.router.navigateByUrl(`/Invoice`);
      }
      Edit_Requirement_SalesMaster(Sales_Master_Id)
      {
      ...
      Invoice_Click(){
        ...
        this.purchasePendingView = false;
        this.packingListPendingView = false;    
        this.Requirement_Master_Service_.Get_Salesmaster_Requirement_Details(this.RequirementMaster_Id_Edit).subscribe(Rows => {
      ...
      DO_Click(){
        ...
        this.purchasePendingView = false;
        this.packingListPendingView = false;
        this.Requirement_Master_Service_.Get_DeliveryOrder_Requirement_Details(this.RequirementMaster_Id_Edit).subscribe(Rows => {
            this.DO_Data=Rows[0];    
            });            
        setTimeout(() => {
            if (this.bottomDiv2) {
      ...
      Edit_Requirement_DeliveryOrder(DeliveryOrderMaster_Id)
      {
      ...
      PackingList_Click(){
        ...
        this.packingListPendingView = false;
        debugger;
        this.Requirement_Master_Service_.Get_PackingList_Requirement_Details(this.RequirementMaster_Id_Edit).subscribe(Rows => {
            debugger;
      ...
      Edit_Requirement_PackingList(PackingList_Master_Id)
      {
      ...
      PO_Click(){
        ...
        this.purchasePendingView = false;
        this.packingListPendingView = false;
        this.Requirement_Master_Service_.Get_PurchaseOrder_Requirement_Details(this.RequirementMaster_Id_Edit).subscribe(Rows => {
            debugger
      ...
      Edit_Requirement_PurchaseOrder(PurchaseOrderMaster_Id)
      {
      ...
      PackingList_Pending_Click(){
        ...
        this.Requirement_Master_Service_.Load_PackingList_Items_Pending_List_ByRequirement(this.Requirement_Master_.RequirementMaster_Id).subscribe(Rows => {
      ...
      Proforma_Click(){
        ...
        this.purchasePendingView = false;
        this.packingListPendingView = false;
        this.Requirement_Master_Service_.Get_Proforma_Requirement_Details(this.RequirementMaster_Id_Edit).subscribe(Rows => {
      ...
      Edit_Requirement_Proforma(PerformaInvoiceMaster_Id)
      {
  ...
  {
    debugger;
    let words = this.Requirement_Master_.Description2.split(' ');
    let result = '';
  ...
  Calculate_Discount_Percent()
  {
    ...
    let discountper = '0';
    debugger;
    if(Number(this.Requirement_Master_.Additional_Discount)>0){
        this.Requirement_Master_.Discount_Description = (this.Requirement_Master_.Additional_Discount * 100/this.Requirement_Master_.TotalAmount).toString()
        discountper = Number(this.Requirement_Master_.Discount_Description).toFixed(3);
        this.Requirement_Master_.Discount_Description = discountper;  
    }else{
        this.Requirement_Master_.Discount_Description = '0.000'
    }
    debugger;
...
// }else{
//     this.Requirement_Master_.Additional_Discount = 0.000
// }
//   this.Final_Amounts();
// }
...
//   Export() {
//     this.Requirement_Master_Service_.exportExcel(this.Requirement_Master_Data,"Requirement" );
//   }
  Export() {
    const filteredData = this.Requirement_Master_Data.map((receipt: any, index: number) => {
        return {
            No: index + 1,                  
            CustomerName: receipt["Customer"],
            RequirementNo: receipt["RequirementNo"],
            Date: receipt["FormattedEntryDate"],
            Amount: receipt["NetTotal"],
        };
    });
    this.Requirement_Master_Service_.exportExcel(filteredData,"Requirement" );}
    /*** Added on 22-11-2024 */
    closeInvoiceListView(){
      ...
      addBlankRows(): void {
        ...
        debugger
        // this.Requirement_Details_Data.forEach((item, index) => {
        ...
        this.Requirement_Details_Data.forEach((_, index) => {
          ...
          if (cell) {
            ...
            if(this.Requirement_Details_Data[index].ItemName.length > 96)
                {
                ...
                console.log('this.Requirement_Details_Data[index].ItemName.length: ', this.Requirement_Details_Data[index].ItemName.length);
            // if(this.Requirement_Details_Data[index].Item_Code.length > 13)
            //     {
            //         this.marginTopItemNameCount = true;
            //     }        
            console.log('this.marginTopItemNameCount: ', this.marginTopItemNameCount);
            // if(this. Requirement_Details_Data[index].ItemName.length )
            // var alenght=  this. Requirement_Details_Data[index].ItemName.length % (100-this.Requirement_Details_Data[index].ItemName.length);
            // console.log('this. Requirement_Details_Data[index].ItemName.length: ', this. Requirement_Details_Data[index].ItemName.length);
...
debugger;
             if (cellThr1 < 410 && (this.Requirement_Details_Data.length < 18 && this.marginTopItemNameCount == false) 
                || (this.Requirement_Details_Data.length < 15 && this.marginTopItemNameCount == true)) {   
       ...
       // for (let x = 0; x <= this. Requirement_Details_Data.length -1; x++) {
        ...
        // this.Requirement_Details_Data.forEach(item => {

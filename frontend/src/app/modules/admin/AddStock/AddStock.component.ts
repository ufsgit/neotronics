...
import { Stock_Add_Master } from '../../../models/Stock_Add_Master';
...
Barcode_:Stock_Add_Details= new Stock_Add_Details();

Item_Temp_:Stock_Add_Details= new Stock_Add_Details();
Barcode_Temp_:Stock_Add_Details= new Stock_Add_Details();
Item_Data:Stock_Add_Details[]
Item_:Stock_Add_Details= new Stock_Add_Details();
Item_Temp:Stock_Add_Details= new Stock_Add_Details();
...
constructor(private route: ActivatedRoute, private router: Router, public dialogBox: MatDialog , private el: ElementRef, private zone: NgZone, 
    private renderer: Renderer2, public Stock_Service_: Stock_Service,public Sales_Master_Service_:Sales_Master_Service,public Stock_Add_Master_Service_:Stock_Add_Master_Service) { }
...
display_ItemCode(item) 
{
 ...
 Get_Stock(){
    ...
    this.Stock_Add_Details_.ItemCode=this.Barcode_.Item_Code;
...
Item_Name_Change(Item_sl:Stock_Add_Details){
 ...
 this.Stock_Add_Details_.MRP=Item_sl.MRP;
 }
Create_New()
{
...
Clr_Stock_Master()
{
    this.Stock_Add_Master_.Stock_Add_Master_Id=0;
...
Clr_Stock_Details()
{
    ...
    this.Stock_Add_Details_.ItemCode="";
    ...
    this.Stock_Add_Details_.Purchase_Rate=0;
    this.Barcode_=null;
    this.Stock_=null;
}
Clr_Sales_Edit_Data()
...
{
    if(this.Stock_Add_Details_.Purchase_Rate ==undefined || this.Stock_Add_Details_.Purchase_Rate ==null)
    this.Stock_Add_Details_.Purchase_Rate =0;
    if(this.Stock_Add_Details_.Quantity ==undefined || this.Stock_Add_Details_.Quantity ==null)
    this.Stock_Add_Details_.Quantity=0;
    this.Stock_Add_Details_.Amount=Number(this.Stock_Add_Details_.Purchase_Rate )*Number(this.Stock_Add_Details_.Quantity);
}
...
{
if(this.Stock_Add_Details_.StockId>0)
    this.Stock_Add_Details_.StockId=this.Stock_Add_Details_.StockId;
else
...
else if(this.Stock_Add_Details_.Purchase_Rate==undefined || this.Stock_Add_Details_.Purchase_Rate==null || this.Stock_Add_Details_.Purchase_Rate==0)
{
...
else if(this.Barcode_!=undefined && this.Barcode_!=null)
{
    ...
    this.Stock_Add_Details_.Item_Code=Barcode_string;
}
    this.Stock_Add_Details_.Expiry_Date=this.New_Date(new Date(moment(this.Stock_Add_Details_.Expiry_Date).format('YYYY-MM-DD')));
...
this.Stock_Add_Details_.Is_Expiry=false;
this.Stock_Add_Details_.Expiry_Date=new Date();
this.Stock_Add_Details_.Expiry_Date=this.New_Date(this.Stock_Add_Details_.Expiry_Date);
this.Barcode_=null;
this.Item_ = null;
...
Save_AddStock(Printstatus:number)
{
    ...
    this.Stock_Add_Master_.Stock_Add_Details=this.Stock_Add_Details_Data;
...
Edit_AddStock_Master(Sales_Master_e:Stock_Add_Master,index)
{ 
    debugger;
    this.Entry_View=true;
    this.Edit_Sales=1;
...
this.issLoading = true;
debugger
this.Sales_Master_Service_.Get_AddStock_Details(Sales_Master_e.Stock_Add_Master_Id).subscribe(Rows => { 
    debugger
    if (Rows != null) {
...
Barcode_Change(Barcode_sl:Stock_Add_Details)
{    
      debugger
...
Edit_AddStock_Detail(Stock_add_details_e:Stock_Add_Details, index){

...
export class OutstandingReportComponent implements OnInit {
        ...
        itemGroupData=[];
        GRNVatReport_Data:any;currentDate;FromDate;ToDate
        Item_Group_Temp: Item_Group = new Item_Group;
        Item_Group_Search:Account_Group = new Account_Group();
        // Item_Group_:Item_Group=new Item_Group();


constructor(public Receipt_Voucher_Service_:Receipt_Voucher_Service, public Item_Group_Service_:Item_Group_Service,
        public Client_Accounts_Service_:Client_Accounts_Service,private route: ActivatedRoute, private router: Router,public dialogBox: MatDialog) { }
ngOnInit() 
{    
...
Search_accountgroup() {
        this.Receipt_Voucher_Service_.Search_accountgroup('').subscribe(Rows => {
            if (Rows != null) {
...
Search_OutstandingReport()
        {
 var Item_Group_Id_=0;

                if(this.Item_Group_Search.Account_Group_Id==undefined ||  this.Item_Group_Search==undefined || this.Item_Group_Search==null)
                        Item_Group_Id_=0
                        else
                        Item_Group_Id_=this.Item_Group_Search.Account_Group_Id;

        this.issLoading=true;
         debugger
        this.Receipt_Voucher_Service_.Search_OutstandingReport(moment(this.Search_FromDate).format('YYYY-MM-DD'),
        moment(this.Search_ToDate).format('YYYY-MM-DD') ,Item_Group_Id_).subscribe(Rows => {

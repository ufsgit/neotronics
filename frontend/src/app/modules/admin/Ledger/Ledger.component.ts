...
Search_Ledger()
  ...
  else
 {
        ...
        this.Receipt_Voucher_Service_.Search_Ledger(moment(this.Search_FromDate).format('YYYY-MM-DD'),moment(this.Search_ToDate).format('YYYY-MM-DD') , ClientAccounts_Id, Voucher_Type_Id).subscribe(Rows => {

...
@Component({
selector: 'app-Price_Request',
templateUrl: './Price_Request.component.html',
styleUrls: ['./Price_Request.component.css'],
providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},]
})

export class Price_RequestComponent implements OnInit, AfterViewInit  {
    ngAfterViewInit() {}
